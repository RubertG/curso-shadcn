...
export default function DashboardLayout({
  ...
  return (
    <>
      ...
      <div className="flex overflow-hidden bg-whit pt-16 dark:bg-slate-900">
        <aside
          id="sidebar"
                ...
                <ul className="space-y-2 pb-2">
                  {links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-base capitalize text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group dark:hover:bg-slate-800 dark:text-slate-100"
                      >
        ...
        <div
          className="bg-gray-900 opacity-50 hidden fixed inset-0 z-10 dark:bg-slate-100"
          id="sidebarBackdrop"
        ></div>
        <div
          id="main-content"
        ...
        >
          ...
          <footer className="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4 print:hidden dark:bg-slate-900">
            ...
            <div className="flex sm:justify-center space-x-6">
              <a href="#" className="text-gray-500 hover:text-gray-900 dark:text-slate-300 dark:hover:text-slate-100">
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
          ...
          <p className="text-center text-sm text-gray-500 my-10 dark:text-slate-300">
